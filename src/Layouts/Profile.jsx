...
const Profile = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="py-7  flex-2 md:py-25 md:px-17 rounded-2xl p-4 bg-cyan-900 shadow-2xl ">
          ...
          <div className="text-white py-4 ">
            <div>
              <Link to="/profile">
                <button className="btn  w-full mb-2 bg-amber-400">
                  <CiUser size={25} />
                  Account Details
                </button>
              </Link>
          ...
          <div className="text-center py-4 text-gray-400">
            <div>
              <button
                ...
                className="btn w-full mb-2 bg-amber-400"
              >
